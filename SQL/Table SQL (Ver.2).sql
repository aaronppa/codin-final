...
CREATE TABLE file (
	...
	board_code INT      NOT NULL,     -- board_code
	board_no   INT    NOT NULL,     -- board_no
	ori_name   VARCHAR(500)  NOT NULL,     -- ori_name
	sys_name   VARCHAR(500)  NOT NULL,     -- sys_name
	file_path  VARCHAR(3000) NOT NULL,     -- file_path
	file_size  INT           NOT NULL      -- file_size
);
