...
<c:if test="${pageResult.count != 0}">
    ...
    <nav class="norHosNav" aria-label="Pagination">
        <ul class="pagination">
    ...
    <script>
	$("nav.norHosNav > ul.pagination > li > a").click (function(e) {
		e.preventDefault();
		...
		$.ajax({
			...
			$("#norPaging").load("norHosPage.do?pageNo="+pageNo+"&ListCount="+hosMap.listCount);
		})
	})
