...
<c:if test="${pageResult.count != 0}">
    ...
    <nav aria-label="Pagination">
        <ul class="pagination">
            ...
            <li <c:if test="${pageResult.pageNo == pageResult.lastPage}">class='disabled'</c:if>><a href="${pageResult.pageNo+1 }">&raquo;</a></li>
            <li <c:if test="${pageResult.pageNo == pageResult.lastPage}">class='disabled'</c:if>><a href="${pageResult.lastPage }">&raquo;&raquo;</a>
            </li>
        </ul>
    </nav>
