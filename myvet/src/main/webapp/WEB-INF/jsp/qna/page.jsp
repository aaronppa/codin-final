...
<c:if test="${pageResult.count != 0}">
    ...
    <nav class="qnaPage" aria-label="Pagination">
        <ul class="pagination">
    ...
    <script>
	$(".qnaPage > ul.pagination > li > a").click (function(e) {
		e.preventDefault();
		...
		window.location.href = "/myvet/qna/list.do?pageNo=" + pageNo + "&order=" + $("#order").val() + "&sort="+ $("#sort").val()+"&keyword="+$("#keyword").val()+"&categoryCode="+$(".categoryCode").val() +"&answered="+  $(".answered").val()
	})
