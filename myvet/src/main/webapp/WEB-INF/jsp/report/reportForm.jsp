	...
	<div class="container">
            ...
            <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" name="reportMemberNo" value="${report.reportMemberNo}">
                        <p class="text-justify">${report.reportMemberNo}</p>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">신고대상</label>
                        <input type="hidden" name="targetMemberNo" value="${report.targetMemberNo}">
                        <p class="text-justify">${report.targetMemberNo}</p>
                    </div>
            </div>
            <!-- 게시판 분류, 게시판 제목-->
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <p class="text-justify">방귀뀌는법</p>
                </div>
            </div>
            <!-- 댓글 내용-->
            <div class="form-group">
                <label for="exampleFormControlTextarea1">댓글내용</label>
                <p class="text-justify">괄약근에 힘을주고 뿌잉뿌잉</p>
            </div>
            <div class="form-group">
