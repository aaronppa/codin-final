	...
	<br>
            ...
            <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="hidden" name="reportMemberNo" value="${reportGallery.writerNo}"><p class="text-justify">${nickname}</p>
                        <p class="text-justify"></p>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">신고대상</label>
                        <input type="hidden" name="targetMemberNo" value="${reportGallery.writerNo}"><p class="text-justify">${reportGallery.writerNo}</p>
                    </div>
            </div>
            <!-- 게시판 분류, 게시판 제목-->
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="hidden" name="boardCode" value="${reportGallery.boardCode}">
                    <p class="text-justify">5959내새끼</p>
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">게시판 제목</label>
                    	<input type="hidden" name="contentNo" value="${reportGallery.writerNo}"><p class="text-justify">${reportGallery.title}</p>
                </div>
            </div>
            <!-- 댓글 내용-->
